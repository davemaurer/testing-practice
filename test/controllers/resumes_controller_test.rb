...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { city: @resume.city, email: @resume.email, name: @resume.name, phone: @resume.phone, state: @resume.state, street: @resume.street, zip: @resume.zip } }
    end
